...
{%- for arg in func.arguments() -%}
    ...
    {%- when Type::Enum(inner) %}
        ...
        {%- else %}
                val {{arg.name()|var_name|unquote|temporary}} = as{{arg.type_()|type_name}}({{ arg.name()|var_name|unquote }}) ?: run { throw SdkException.Generic("Missing mandatory field {{arg.name()|var_name|unquote}} of type {{ arg.type_()|type_name }}") }
        {%- endif %}
